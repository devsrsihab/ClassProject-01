...
$(function() {
    ...
    $('.navigation-alt').find('li').has('ul').children('a').on('click', function (e) {
        ...
        // Collapsible
        $(this).parent('li').not('.disabled').toggleClass('sr_active').children('ul').slideToggle(200);

        // Accordion
        if ($('.navigation-alt').hasClass('navigation-accordion')) {
            $(this).parent('li').not('.disabled').siblings(':has(.has-ul)').removeClass('sr_active').children('ul').slideUp(200);
        }
    }); 
