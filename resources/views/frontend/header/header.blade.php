		...
		<div class="container">
					...
					<ul class="dropdown-menu z-index-unset" aria-labelledby="categoryMenu">
						...
						<li class="dropdown-submenu dropend">
							...
							<div class="dropdown-menu dropdown-menu-start dropdown-width-lg" data-bs-popper="none">
								<div class="row p-4">
									...
									<div class="col-xl-6 col-xxl-4 mb-4 mb-xl-0">
										...
										<div class="d-flex mb-4 position-relative">
											<img src="{{ asset('frontend/assets/images/client/uni-logo-01.svg') }}" class="icon-md" alt="">
											<div class="ms-3">
										...
										<!-- Dropdown item -->
										<div class="d-flex mb-4 position-relative">
											<img src="{{ asset('frontend/assets/images/client/uni-logo-02.svg') }}" class="icon-md" alt="">
											<div class="ms-3">
										...
										<!-- Dropdown item -->
										<div class="d-flex mb-4 position-relative">
											<img src="{{ asset('frontend/assets/images/client/uni-logo-03.svg') }}" class="icon-md" alt="">
											<div class="ms-3">
										...
										<div class="d-flex position-relative">
											<img src="{{ asset('frontend/assets/images/client/uni-logo-04.svg') }}" class="icon-md" alt="">
											<div class="ms-3">
								...
								<div class="row">
									<div class="col-12">
										<div class="card bg-blue rounded-0 rounded-bottom p-3 position-relative overflow-hidden" style="background:url({{ asset('frontend/assets/') }}images/pattern/05.png) no-repeat center center; background-size:cover;">
											<!-- SVG decoration -->
			...
			<ul class="navbar-nav navbar-nav-scroll me-3 d-none d-xl-block">
				<li class="nav-item dropdown">
					...
					<ul class="dropdown-menu dropdown-menu-end min-w-auto" aria-labelledby="language">
						<li> <a class="dropdown-item" href="#"><img class="fa-fw me-2" src="{{ asset('frontend/assets/') }}images/flags/uk.svg" alt="">English</a></li>
						<li> <a class="dropdown-item" href="#"><img class="fa-fw me-2" src="{{ asset('frontend/assets/') }}images/flags/gr.svg" alt="">German</a></li>
						<li> <a class="dropdown-item" href="#"><img class="fa-fw me-2" src="{{ asset('frontend/assets/') }}images/flags/sp.svg" alt="">French</a></li>
					</ul>
				</li>
			</ul>
			...
			<div class="dropdown ms-1 ms-lg-0">
				<a class="avatar avatar-sm p-0" href="#" id="profileDropdown" role="button" data-bs-auto-close="outside" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false">
					<img class="avatar-img rounded-circle" src="{{ asset('frontend/assets/images/avatar/01.jpg') }}" alt="avatar">
				</a>
				<ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3" aria-labelledby="profileDropdown">
					...
					<li class="px-3 mb-3">
						<div class="d-flex align-items-center">
							...
							<div class="avatar me-3">
								<img class="avatar-img rounded-circle shadow" src="{{ asset('frontend/assets/images/avatar/01.jpg') }}" alt="avatar">
							</div>
							<div>
								...
								<p class="small m-0">
									@php
									if (Auth::check()) {
										$usersMail = Illuminate\Support\Facades\Auth::user()->email;
										echo $usersMail;
									}                               
								   @endphp
								</p>
					...
					<li> <hr class="dropdown-divider"></li>
					<!-- Links -->
					<li><a class="dropdown-item" href="{{ url('studetn_dashoard') }}"><i class="bi bi-person fa-fw me-2"></i>Edit Profile</a></li>
			...
			<div class="navbar-nav d-none d-lg-inline-block">
			 <a href="{{ route('login') }}"><button class="btn btn-danger-soft mb-0"><i class="fas fa-sign-in-alt me-2"></i>Sign in</button></a>	
			</div>	
			@endif
			<!-- Profile END -->
