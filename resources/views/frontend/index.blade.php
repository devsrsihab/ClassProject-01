            ...
            <div class="row position-relative mb-0 mb-sm-5 pb-0 pb-lg-5">
                <div class="col-lg-8 text-center mx-auto position-relative">
                    ...
                    <p>Get inspired and discover something new today. Grow your skill with the most reliable online
                        courses and certifications in marketing, information technology, programming, and data science.
                    </p>
                ...
                <div class="col-md-8 text-center mx-auto">
                    <div class="card card-body shadow p-2">
                        <div class="position-relative">
                            <!-- Image -->
                            <img src="{{ asset('frontend/assets/images/about/12.jpg') }}" class="card-img rounded-2" alt="...">
            ...
            <div class="row g-4">
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="card card-body shadow rounded-3">
                        <div class="d-flex align-items-center">
                            <!-- Icon -->
                            <div class="icon-lg bg-warning bg-opacity-15 rounded-circle text-warning"><i
                    ...
                    <div class="card p-2 shadow h-100">
                        <div class="rounded-top overflow-hidden">
                            <div class="card-overlay-hover">
                                <!-- Image -->
                                <img src="{{ asset('frontend/assets/images/courses/4by3/17.jpg') }}" class="card-img-top" alt="course image">
                            </div>
                            <!-- Hover element -->
                            <div class="card-img-overlay">
                        ...
                        <div class="card-body px-2">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="avatar avatar-sm">
                                    <img class="avatar-img rounded-circle" src="{{ asset('frontend/assets/images/avatar/09.jpg') }}"
                                        alt="avatar">
                                </div>
                            </div>
                            <!-- Divider -->
                ...
                <div class="col-md-6 col-lg-4 col-xxl-3">
                    <div class="card p-2 shadow h-100">
                        <div class="rounded-top overflow-hidden">
                            <div class="card-overlay-hover">
                                <!-- Image -->
                                <img src="{{ asset('frontend/assets/images/courses/4by3/18.jpg') }}" class="card-img-top" alt="course image">
                            </div>
                            <!-- Hover element -->
                            <div class="card-img-overlay">
                                <div class="card-element-hover d-flex justify-content-end">
                        ...
                        <div class="card-body px-2">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <!-- Avatar -->
                                <div class="avatar avatar-sm">
                                    <img class="avatar-img rounded-circle" src="{{ asset('frontend/assets/images/avatar/07.jpg') }}"
                                        alt="avatar">
                                </div>
                            </div>
                            <!-- Divider -->
                ...
                <div class="col-md-6 col-lg-4 col-xxl-3">
                    <div class="card p-2 shadow h-100">
                        <div class="rounded-top overflow-hidden">
                            <div class="card-overlay-hover">
                                <!-- Image -->
                                <img src="{{ asset('frontend/assets/images/courses/4by3/21.jpg') }}" class="card-img-top" alt="course image">
                            </div>
                            <!-- Hover element -->
                            <div class="card-img-overlay">
                                <div class="card-element-hover d-flex justify-content-end">
                        ...
                        <div class="card-body px-2">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <!-- Avatar -->
                                <div class="avatar avatar-sm">
                                    <img class="avatar-img rounded-circle" src="{{ asset('frontend/assets/images/avatar/05.jpg') }}"
                                        alt="avatar">
                                </div>
                            </div>
                            <!-- Divider -->
                ...
                <div class="col-md-6 col-lg-4 col-xxl-3">
                    <div class="card p-2 shadow h-100">
                        <div class="rounded-top overflow-hidden">
                            <div class="card-overlay-hover">
                                <!-- Image -->
                                <img src="{{ asset('frontend/assets/images/courses/4by3/20.jpg') }}" class="card-img-top" alt="course image">
                            </div>
                            <!-- Hover element -->
                            <div class="card-img-overlay">
                                <div class="card-element-hover d-flex justify-content-end">
                        ...
                        <div class="card-body px-2">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <!-- Avatar -->
                                <div class="avatar avatar-sm">
                                    <img class="avatar-img rounded-circle" src="{{ asset('frontend/assets/images/avatar/02.jpg') }}"
                                        alt="avatar">
                                </div>
                            </div>
                            <!-- Divider -->
                ...
                <div class="col-md-6 col-lg-4 col-xxl-3">
                    <div class="card p-2 shadow h-100">
                        <div class="rounded-top overflow-hidden">
                            <div class="card-overlay-hover">
                                <!-- Image -->
                                <img src="{{ asset('frontend/assets/images/courses/4by3/15.jpg') }}" class="card-img-top" alt="course image">
                            </div>
                            <!-- Hover element -->
                            <div class="card-img-overlay">
                                <div class="card-element-hover d-flex justify-content-end">
                        ...
                        <div class="card-body px-2">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <!-- Avatar -->
                                <div class="avatar avatar-sm">
                                    <img class="avatar-img rounded-circle" src="{{ asset('frontend/assets/images/avatar/11.jpg') }}"
                                        alt="avatar">
                                </div>
                            </div>
                            <!-- Divider -->
                ...
                <div class="col-md-6 col-lg-4 col-xxl-3">
                    <div class="card p-2 shadow h-100">
                        <div class="rounded-top overflow-hidden">
                            <div class="card-overlay-hover">
                                <!-- Image -->
                                <img src="{{ asset('frontend/assets/images/courses/4by3/14.jpg') }}" class="card-img-top" alt="course image">
                            </div>
                            <!-- Hover element -->
                            <div class="card-img-overlay">
                                <div class="card-element-hover d-flex justify-content-end">
                        ...
                        <div class="card-body px-2">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <!-- Avatar -->
                                <div class="avatar avatar-sm">
                                    <img class="avatar-img rounded-circle" src="{{ asset('frontend/assets/images/avatar/12.jpg') }}"
                                        alt="avatar">
                                </div>
                            </div>
                            <!-- Divider -->
                ...
                <div class="col-md-6 col-lg-4 col-xxl-3">
                    <div class="card p-2 shadow h-100">
                        <div class="rounded-top overflow-hidden">
                            <div class="card-overlay-hover">
                                <!-- Image -->
                                <img src="{{ asset('frontend/assets/images/courses/4by3/19.jpg') }}" class="card-img-top" alt="course image">
                            </div>
                            <!-- Hover element -->
                            <div class="card-img-overlay">
                                <div class="card-element-hover d-flex justify-content-end">
                        ...
                        <div class="card-body px-2">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <!-- Avatar -->
                                <div class="avatar avatar-sm">
                                    <img class="avatar-img rounded-circle" src="{{ asset('frontend/assets/images/avatar/08.jpg') }}"
                                        alt="avatar">
                                </div>
                            </div>
                            <!-- Divider -->
                ...
                <div class="col-md-6 col-lg-4 col-xxl-3">
                    <div class="card p-2 shadow h-100">
                        <div class="rounded-top overflow-hidden">
                            <div class="card-overlay-hover">
                                <!-- Image -->
                                <img src="{{ asset('frontend/assets/images/courses/4by3/16.jpg') }}" class="card-img-top" alt="course image">
                            </div>
                            <!-- Hover element -->
                            <div class="card-img-overlay">
                                <div class="card-element-hover d-flex justify-content-end">
                        ...
                        <div class="card-body px-2">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <!-- Avatar -->
                                <div class="avatar avatar-sm">
                                    <img class="avatar-img rounded-circle" src="{{ asset('frontend/assets/images/avatar/06.jpg') }}"
                                        alt="avatar">
                                </div>
                            </div>
                            <!-- Divider -->
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-6 position-relative overflow-hidden">
                    <div class="bg-primary bg-opacity-10 rounded-3 p-5 h-100">
                        ...
                        <div class="position-absolute bottom-0 end-0 me-3">
                            <img src="{{ asset('frontend/assets/images/element/08.svg') }}" class="h-100px h-sm-200px" alt="">
                        </div>
                        <!-- Content -->
                        <div class="row">
                ...
                <div class="col-lg-6 position-relative overflow-hidden">
                    <div class="bg-secondary rounded-3 bg-opacity-10 p-5 h-100">
                        <!-- Image -->
                        <div class="position-absolute bottom-0 end-0 me-3">
                            <img src="{{ asset('frontend/assets/images/element/15.svg') }}" class="h-100px h-sm-200px" alt="">
                        </div>
                        <!-- Content -->
                        <div class="row">
                            <div class="col-sm-8 position-relative">
            ...
            <div class="row g-4">
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    ...
                    <div class="card card-metro overflow-hidden rounded-3">
                        <img src="{{ asset('frontend/assets/images/courses/4by3/01.jpg') }}" alt="">
                        <!-- Image overlay -->
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <!-- Image -->
                    <div class="card card-metro overflow-hidden rounded-3">
                        <img src="{{ asset('frontend/assets/images/courses/4by3/03.jpg') }}" alt="">
                        <!-- Image overlay -->
                        <div class="card-img-overlay d-flex">
                            <!-- Info -->
                            <div class="mt-auto card-text">
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <!-- Image -->
                    <div class="card card-metro overflow-hidden rounded-3">
                        <img src="{{ asset('frontend/assets/images/courses/4by3/05.jpg') }}" alt="">
                        <!-- Image overlay -->
                        <div class="card-img-overlay d-flex">
                            <!-- Info -->
                            <div class="mt-auto card-text">
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <!-- Image -->
                    <div class="card card-metro overflow-hidden rounded-3">
                        <img src="{{ asset('frontend/assets/images/courses/4by3/06.jpg') }}" alt="">
                        <!-- Image overlay -->
                        <div class="card-img-overlay d-flex">
                            <!-- Info -->
                            <div class="mt-auto card-text">
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <!-- Image -->
                    <div class="card card-metro overflow-hidden rounded-3">
                        <img src="{{ asset('frontend/assets/images/courses/4by3/07.jpg') }}" alt="">
                        <!-- Image overlay -->
                        <div class="card-img-overlay d-flex">
                            <!-- Info -->
                            <div class="mt-auto card-text">
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <!-- Image -->
                    <div class="card card-metro overflow-hidden rounded-3">
                        <img src="{{ asset('frontend/assets/images/courses/4by3/08.jpg') }}" alt="">
                        <!-- Image overlay -->
                        <div class="card-img-overlay d-flex">
                            <!-- Info -->
                            <div class="mt-auto card-text">
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <!-- Image -->
                    <div class="card card-metro overflow-hidden rounded-3">
                        <img src="{{ asset('frontend/assets/images/courses/4by3/09.jpg') }}" alt="">
                        <!-- Image overlay -->
                        <div class="card-img-overlay d-flex">
                            <!-- Info -->
                            <div class="mt-auto card-text">
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <!-- Image -->
                    <div class="card card-metro overflow-hidden rounded-3">
                        <img src="{{ asset('frontend/assets/images/courses/4by3/10.jpg') }}" alt="">
                        <!-- Image overlay -->
                        <div class="card-img-overlay d-flex">
                            <!-- Info -->
                            <div class="mt-auto card-text">
        ...
        <div class="container">
            ...
            <div class="row g-4 align-items-center justify-content-between">
                ...
                <div class="col-md-6 col-xl-4">
                    ...
                    <p>How promotion excellent curiosity yet attempted happiness prosperous impression had conviction
                            ...
                            <div class="tiny-slider-inner" data-autoplay="false" data-edge="2" data-arrow="true"
                                ...
                                <div>
                                    <div class="card p-2">
                                        <div class="position-relative">
                                            <!-- Image -->
                                            <img src="{{ asset('frontend/assets/images/courses/4by3/18.jpg') }}" class="card-img rounded-2"
                                                alt="Card image">
                                            <div class="card-img-overlay">
                                                <div class="position-absolute top-50 start-50 translate-middle">
                                                    <!-- Video link -->
                                                    ...
                                                    <ul class="avatar-group mb-2 mb-sm-0">
                                                        <li class="avatar avatar-xs">
                                                            <img class="avatar-img rounded-circle"
                                                                src="{{ asset('frontend/assets/images/avatar/01.jpg') }}" alt="avatar">
                                                        </li>
                                                        <li class="avatar avatar-xs">
                                                            <img class="avatar-img rounded-circle"
                                                                src="{{ asset('frontend/assets/images/avatar/02.jpg') }}" alt="avatar">
                                                        </li>
                                                        <li class="avatar avatar-xs">
                                                            <img class="avatar-img rounded-circle"
                                                                src="{{ asset('frontend/assets/images/avatar/03.jpg') }}" alt="avatar">
                                                        </li>
                                                        <li class="avatar avatar-xs">
                                                            <img class="avatar-img rounded-circle"
                                ...
                                <div>
                                    <div class="card p-2">
                                        <div class="position-relative">
                                            <!-- Image -->
                                            <img src="{{ asset('frontend/assets/images/courses/4by3/22.jpg') }}" class="card-img rounded-2"
                                                alt="Card image">
                                            <div class="card-img-overlay">
                                                <div class="position-absolute top-50 start-50 translate-middle">
                                                    <!-- Video link -->
                                ...
                                <div>
                                    <div class="card p-2">
                                        <div class="position-relative">
                                            <!-- Image -->
                                            <img src="{{ asset('frontend/assets/images/courses/4by3/21.jpg') }}" class="card-img rounded-2"
                                                alt="Card image">
                                            <div class="card-img-overlay">
                                                <div class="position-absolute top-50 start-50 translate-middle">
                                                    <!-- Video link -->
                                        ...
                                        <div class="card-body">
                                            <!-- Title -->
                                            <h5><a href="#">English for Beginners: Intensive Spoken English Course</a>
                                            </h5>
                                            <!-- Avatar group and button -->
                                            <div class="d-sm-flex justify-content-sm-between align-items-center mt-3">
                                                <!-- Avatar Group -->
                            ...
                            <div class="col-11 position-relative">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-7">
                                        ...
                                        <p class="text-white small">Boost up your knowledge, grow your skill with the
                                            most reliable online courses and certifications</p>
                                        <!-- List -->
