...
<div class="container">
    ...
    <div class="row">
        ...
        @endif
            <form class="form-horizontal" action="{{ route('CourseArchives.update',$CourseArchivesEdit->id) }}" method="POST">
                @method('PUT')
                @csrf
                <fieldset class="content-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control" id="course_name" name="course_name" value="{{ $CourseArchivesEdit->course_name }}">
                            @error('course_name')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <textarea rows="5" cols="5" class="form-control" id="course_des" placeholder="Default textarea" name="course_des">{{ $CourseArchivesEdit->course_des }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control" id="price" name="price" value="{{ $CourseArchivesEdit->price }}">
                        </div>
                    </div>
