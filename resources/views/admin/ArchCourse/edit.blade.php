...
<div class="container">
    ...
    <div class="row">
        ...
        @endif
            <form class="form-horizontal" action="{{ url('admin/ArchCourses/Update/'.$ArchiveCourses->id) }}" method="POST">
                @csrf
                <fieldset class="content-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control" id="arch_name" name="arch_name" value="{{ $ArchiveCourses->arch_name }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <textarea rows="5" cols="5" id="arch_description" name="arch_description" class="form-control" placeholder="Archive Courses Resource">{{ $ArchiveCourses->arch_description }}</textarea>
                        </div>
                    </div>
                ...
                <div class="text-right">
                    <button type="submit" class="btn btn-primary">Update Archive Course <i class="icon-arrow-right14 position-right"></i></button>
                </div>
            </form>
        </div>
    </div>
